import 'package:cocktails/ui/widgets/startup_issues.dart';
...
void main() {
  group('startup issues', () {
    testWidgets('a healthy store leaves the banner out', (tester) async {
      await pumpScreen(tester, const StartupIssues());
      expect(find.byType(MaterialBanner), findsNothing);
    });

    testWidgets('a corrupt store names what could not be read', (tester) async {
      await pumpScreen(tester, const StartupIssues(), store: corruptStore());
      expect(
